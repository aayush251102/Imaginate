  ...
  return (
    ...
    text-center my-20'>
        ...
        <h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px]
         ...
         <p className='text-center max-w-xl mx-auto mt-5'>Unleash your creativity with AI. Turn your imagination
            into visual art in seconds - just type, and watch the magic happen.
         </p>

         <button>Generate Images <img src={assets.star_group} alt="" /></button>
    </div>
  )
}
