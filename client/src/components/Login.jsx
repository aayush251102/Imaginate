...
{ state != 'Login' &&
          ...
          rounded-full mt-3'>
             ...
             <input className='outline-none text-sm bg-white' type="text" placeholder='Full Name' required />
          </div>
}
          ...
          rounded-full mt-5'>
             ...
             <input className='outline-none text-sm bg-white' type="email" placeholder='Email id' required />
          </div>

          <div className='border px-6 py-2 flex items-center gap-2
          rounded-full mt-3'>
             <img  src={assets.lock_icon} alt="" />
             <input className='outline-none text-sm bg-white' type="password" placeholder='Password' required />
          </div>
